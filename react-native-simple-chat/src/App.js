...
import {Asset} from 'expo-asset' // expo-asset : 로컬 이미지/파일을 앱에 미리 로드할 때 사용하는 패키지
import * as Font from 'expo-font' //expo-font : 커스텀 폰트를 로드하는 라이브러리
import * as SplashScreen from 'expo-splash-screen' //expo-splash-screen : 앱 실행시 스플래시 화면을 제어하는 라이브러리
